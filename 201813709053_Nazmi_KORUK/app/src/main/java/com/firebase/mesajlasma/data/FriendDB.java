...
public final class FriendDB {
    ...
    public ListFriend getListFriend() {
        ...
        // Bu sorgudan sonra gerçekten veritabanından hangi sütunları
        // kullanacağınızı belirten bir izdüşüm tanımlayın.
        try {
    ...
    private static class FriendDBHelper extends SQLiteOpenHelper {
        // Veritabanı şemasını değiştirirseniz, veritabanı sürümünü artırmanız gerekir.
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            // Bu veritabanı yalnızca çevrimiçi veriler için bir önbellektir, bu nedenle yükseltme politikası
            //sadece verileri atmak ve baştan başlamak için
            db.execSQL(SQL_DELETE_ENTRIES);
            onCreate(db);
        }
