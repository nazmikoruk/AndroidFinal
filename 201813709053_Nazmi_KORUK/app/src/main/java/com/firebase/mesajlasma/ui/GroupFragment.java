        ...
        switch (item.getItemId()) {
            case CONTEXT_MENU_DELETE:
                ...
                if(((String)listGroup.get(posGroup).groupInfo.get("admin")).equals(StaticConfig.UID)) {
                    ...
                    Toast.makeText(getActivity(), "Admin Değilsiniz", Toast.LENGTH_LONG).show();
                }
                break;
            ...
            case CONTEXT_MENU_LEAVE:
                ...
                if(((String)listGroup.get(position).groupInfo.get("admin")).equals(StaticConfig.UID)) {
                    Toast.makeText(getActivity(), "Admin Gruptan Ayrılamaz", Toast.LENGTH_LONG).show();
                }else{
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            new LovelyInfoDialog(getContext())
                                    ...
                                    .setIcon(R.drawable.ic_dialog_delete_group)
                                    .setTitle("Hata")
                                    .setMessage("Grup Silinemedi Tekrar Deneyiniz.")
                                    .setCancelable(false)
