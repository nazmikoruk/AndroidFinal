...
public class LoginActivity extends AppCompatActivity {
    ...
    public void clickLogin(View view) {
        ...
        if (validate(username, password)) {
            ...
            Toast.makeText(this, "Geçersiz email veya yanlış parola!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    //şifremi unuttum kısmı için epostayı girip forgot your password a tıklayınca mail adresine doğrulama linki gönderiliyor.
    ...
    class AuthUtils {
        void createUser(String email, String password) {
            waitingDialog.setIcon(R.drawable.ic_add_friend)
                    .setTitle("Kayıt gerçekleştiriliyor...")
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setMessage("E-posta kayıtlı veya zayıf şifre!")
                                        .setConfirmButtonText("ok")
                                        .setCancelable(false)
                                        .show();
                            } else {
                                initNewUserInfo();
                                Toast.makeText(LoginActivity.this, "Kayıt ve giriş başarılı", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                                LoginActivity.this.finish();
                            }
                        }
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setMessage("Eposta bulunamadı veya yanlış parola!")
                                        .setCancelable(false)
                                        .setConfirmButtonText("Ok")
                                        .show();
                            } else {
                ...
                public void onFailure(@NonNull Exception e) {
                    new LovelyInfoDialog(LoginActivity.this) {
                        ...
                        public LovelyInfoDialog setConfirmButtonText(String text) {
                            ...
                            .setIcon(R.drawable.ic_pass_reset)
                            .setTitle("Hatalı")
                            .setMessage("Gönderilen e-posta yanlış " + email)
                            .setConfirmButtonText("Ok")
                            .show();
                }
            });
